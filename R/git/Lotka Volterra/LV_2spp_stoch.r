...
# parameters -----------------------------------------
  ...
  simul = simul0[which(simul[,1]<=simul[,2]),] # ERROR>Lucas: they are trying to use the info of a vector that is not yet defined. simul[,1] and simul[,2] are empty at the moment
  maxtime=5000
  initialNsp1 = 5
  initialNsp2 = 5
  a11=1
