...
- [csv/annplant_2spp_det_rare.txt](https://github.com/Tungdil01/Annual_Plant_Model/blob/main/csv/annplant_2spp_det_rare.txt)  
  This file is the original dataset from [Yenni 2013](https://github.com/gmyenni/RareStabilizationSimulation/blob/master/Annual%20Plant/annplant_2spp_det_rare.txt), provided as a reference. It is not generated by any script but is used optionally for comparison in `code_for_reproducibility.py` and `main_appendix.py`.  
