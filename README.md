...
All CSV files in the `csv/` folder are generated by the scripts in this repository, except as noted. Missing values are represented as `NaN`.
...
| `nu` | float | Strength of self‑limitation = (N<sub>1</sub>−N<sub>2</sub>)(S<sub>1</sub>−S<sub>2</sub>)/2 (Yenni et al. 2012) | individuals |
| `nu_C` | float | Competition effect = (N<sub>1</sub>−N<sub>2</sub>)(CE<sub>1</sub>−CE<sub>2</sub>)/2 ([Streipert and Wolkowicz 2023](https://doi.org/10.1016/j.mbs.2022.108924)) | individuals<sup>2</sup> |
...
| `rare_extinction_rate`, `common_extinction_rate` | float | Proportion of simulations in which rare/common species goes extinct | proportion |
