...
[main_simulation.py](https://github.com/Tungdil01/Annual_Plant_Model/blob/main/main_simulation.py) reproduces the core numerical experiments and generates the main results (Figures 1a, 1b, and S2). It also produces Figure S1 (phase plane diagrams). The script performs Latin hypercube sampling of model parameters for both Beverton–Holt and Ricker competition models, computes analytical equilibria and coexistence metrics (e.g., strength of self‑limitation ν and competition effect ν_C), and evaluates how well these metrics predict coexistence versus competitive exclusion under rare‑species scenarios.
